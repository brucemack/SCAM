...
class PA_2(Compound):
    ...
    def __init__(self, rotation_ccw=0):
        ...
        start_point = rotate((1 * self.pitch_mm, 1 * self.pitch_mm), rotation_ccw)
        end_point = rotate((5 * self.pitch_mm, 1 * self.pitch_mm), rotation_ccw)
        self.add(self.NO_OFFSET, Line(start_point, end_point))
        ...
        start_point = rotate((4 * self.pitch_mm, 2 * self.pitch_mm), rotation_ccw)
        end_point = rotate((5 * self.pitch_mm, 2 * self.pitch_mm), rotation_ccw)
        self.add(self.NO_OFFSET, Line(start_point, end_point))

        start_point = rotate((0 * self.pitch_mm, 3 * self.pitch_mm), rotation_ccw)
        end_point = rotate((3 * self.pitch_mm, 3 * self.pitch_mm), rotation_ccw)
        self.add(self.NO_OFFSET, Line(start_point, end_point))
        ...
        start_point = rotate((3 * self.pitch_mm, 5 * self.pitch_mm), rotation_ccw)
        end_point = rotate((4 * self.pitch_mm, 5 * self.pitch_mm), rotation_ccw)
        self.add(self.NO_OFFSET, Line(start_point, end_point))
        ...
        start_point = rotate((1 * self.pitch_mm, 1 * self.pitch_mm), rotation_ccw)
        end_point = rotate((1 * self.pitch_mm, 4 * self.pitch_mm), rotation_ccw)
        self.add(self.NO_OFFSET, Line(start_point, end_point))
        ...
        start_point = rotate((5 * self.pitch_mm, 1 * self.pitch_mm), rotation_ccw)
        end_point = rotate((5 * self.pitch_mm, 4 * self.pitch_mm), rotation_ccw)
        self.add(self.NO_OFFSET, Line(start_point, end_point))
